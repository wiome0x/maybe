module ImportsHelper
  ...
  def dry_run_resource(key)
    map = {
      ...
      records: DryRunResource.new(label: "Records", icon: "database", text_class: "text-gray-500", bg_class: "bg-gray-500/5")
    }
  ...
  private
    def permitted_import_types
      %w[transaction_import trade_import account_import mint_import ibkr_import historical_data_import]
    end
