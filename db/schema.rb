...
ActiveRecord::Schema[7.2].define(version: 2026_04_28_230000) do
  ...
  create_table "entries", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "plaid_id"
    t.jsonb "locked_attributes", default: {}
    t.string "import_idempotency_key"
    t.index "lower((name)::text)", name: "index_entries_on_lower_name"
    t.index ["account_id", "date"], name: "index_entries_on_account_id_and_date"
    t.index ["account_id", "import_idempotency_key"], name: "index_entries_on_account_id_and_idempotency_key", unique: true, where: "(import_idempotency_key IS NOT NULL)"
  ...
  create_table "market_alert_rules", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "rule_type", default: "market", null: false
    t.index ["user_id", "rule_type"], name: "index_market_alert_rules_on_user_id_and_rule_type"
