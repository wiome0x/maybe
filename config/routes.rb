...
Rails.application.routes.draw do
  ...
  namespace :settings do
    ...
    resource :market_alert, only: :show, controller: "market_alerts"
  ...
  get "heatmap", to: "public/markets#stocks_heatmap", as: :public_heatmap
  get "heatmap/news", to: "public/markets#stocks_news", as: :public_heatmap_news
  get "public", to: redirect("/heatmap")
  get "public/markets/stocks/heatmap", to: redirect("/heatmap")
  get "public/markets/stocks/news", to: redirect("/heatmap/news")
